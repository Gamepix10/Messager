...
async def main():
    ...
    nickname = await input("Войти в чат", required=True, placeholder="Ваше имя", validate=lambda n: "Такой никнейм уже используется!" if n in online_users or n == ' ' else None)
...
if __name__ == "__main__":
    start_server(main, debug=True, port=1028, cdn=False, remote_access=True)
